...
|------|------|------|
| 主色 | `#1A1A2E` | 深靛蓝 — 沉稳、质感 |
| 辅色 | `#E8D5B7` | 暖金/米色 — 温暖、时光感 |
| 强调色 | `#C49B63` | 琥珀金 — 高光、按钮 |
| 背景色 | `#F5F0EB` | 暖白 — 正文区域 |
| 文字色 | `#2D2D2D` | 深灰 — 可读性 |
...
| 用途 | 中文 | 英文 |
|------|------|------|
| 标题 | 思源宋体 (Noto Serif SC) | Playfair Display |
| 正文 | 思源黑体 (Noto Sans SC) | Inter |
| 装饰数字 | — | Cormorant Garamond |

### 8.4 关键视觉元素

- **胶片质感**: 老照片轻微颗粒感
- **时间轴线条**: 贯穿首页和故事分享的设计语言
- **留白充足**: 内容量大，留白保证呼吸感
